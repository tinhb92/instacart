...
```{r}
# step 3
#if want to rsqlite, must change my code from using dplyr to sql code
...
# orderp <- as.tibble(dbReadTable(instacart, "orderp"))
...
```{r}
# Step 4 ----------------------------------------------------
ordert <- as.tibble(dbReadTable(instacart, "orderp"))
