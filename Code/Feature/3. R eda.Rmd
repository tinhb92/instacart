...
if (SUBSET) {
  write.csv(data, file.path(subset_path, "train_subset.csv"))
  write.csv(train_results, file.path(subset_path, "train_subset_results.csv"))
  write.csv(filter_none, file.path(subset_path, "filter_none.csv"))
  rm(data)
  rm(train_results)
  gc()
}
