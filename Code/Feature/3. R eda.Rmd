...
instacart <- dbConnect(SQLite(), "instacart.sqlite")
dbWriteTable(instacart, name = "order_products__prior", order_products__prior)
dbWriteTable(instacart, name = "order_products__train", order_products__train)
dbWriteTable(instacart, name = "orders", orders)
...
dbWriteTable(instacart, name = "ordert", ordert)
dbWriteTable(instacart, name = "orderp", orderp)
...
dbWriteTable(instacart, name = "users", users)
dbWriteTable(instacart, name = "prd", prd)
...
```{r}
data %>%
  filter(is.na(prod_reorder_third))
```
